...
实际执行后的状态另见[研究状态登记](RESEARCH_STATUS_REGISTER.md)。首轮
[A1-PILOT-001](A1_PILOT_001_RESULTS.md)标为 `RC:A1 / RC:C2 / END`：12 个初值的有限
求根检验完成，未发现线外候选；这个状态不代表 A1 整个方向结束。图保持通用图例，
不将单个条目的 END 状态贴到整个 A1 节点。
